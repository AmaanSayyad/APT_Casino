...
const HowItWorksSection = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Power your gameplay with APTC tokens – our exclusive in-game currency built on Bitcoin Supported Network. Easily swap from any token or other cryptocurrencies.',
      emoji: '💰'
    },
    {
      id: 3,
